...
import static org.sonicx.common.utils.BIUtil.isLessThan;
import static org.sonicx.common.utils.ByteUtil.bigIntegerToBytes;
...
import org.sonicx.common.crypto.jce.ECKeyAgreement;
import org.sonicx.common.crypto.jce.ECKeyFactory;
import org.sonicx.common.crypto.jce.ECKeyPairGenerator;
import org.sonicx.common.crypto.jce.ECSignatureFactory;
...
public class ECKey implements Serializable {
  ...
  public ECKey(SecureRandom secureRandom) {
    this(SonicxCastleProvider.getInstance(), secureRandom);
  }
  ...
  public ECKey(@Nullable BigInteger priv, ECPoint pub) {
    this(
        SonicxCastleProvider.getInstance(),
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        return ECKeyFactory
            .getInstance(SonicxCastleProvider.getInstance())
